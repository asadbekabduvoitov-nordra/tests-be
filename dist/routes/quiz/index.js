...
router.get("/:quizz_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { count } = yield supabase_1.supabase.from("tests").select("id", { count: "exact" }).eq("quiz_id", quizz_id);
    if (quiz_error) {
        return res.status(500).json({
            message: "error",
            error: quiz_error === null || quiz_error === void 0 ? void 0 : quiz_error.message
        });
    }
    return res.status(200).json({
        message: "success",
        data: Object.assign(Object.assign({}, quiz), { tests_count: count })
    });
}));
